export const projectReasons = `Next oferece uma estrutura robusta e moderna:
...
export const aprendizados = `Este projeto serve como exemplo prático de:

[1] Animações com Framer Motion
[2] Boas práticas de componentização
[3] Estilização moderna com TailwindCSS
[4] Implementação de layouts responsivos
[5] Gerenciamento de estado com React Hooks
[6] Organização de código em uma aplicação Next.js
`;

export const RecursosF =`Tecnologias utilizadas no desenvolvimento:
